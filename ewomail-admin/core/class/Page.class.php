...
class Page{
    ...
    public function __construct($totalRows, $listRows=20, $parameter = array()) {
        ...
        $this->limit = 'limit '.$this->firstRow.','.$this->listRows;
    }
    ...
    public function show() {
        ...
        $url = $parse['path'].'?'.http_build_query($this->parameter);
        $this->url = $url;
        /* 计算分页信息 */
        ...
        $_n = ($down_row <= $this->totalPages) ? $down_row:$this->totalPages;
        $down_page = '<a class="next" href="' . $this->url($_n) . '">' . $this->config['next'] . '</a>' ;
